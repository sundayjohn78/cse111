...
def main():
    ...
    mass = float(input("Enter the molar mass: "))
    ...
    #calling the get_formula_name function
    known_formula = get_formula_name(formula, known_molecules_dict)
    print(f"{molar_mass:.5f} grams/mole")
    print(f"{number_of_moles:.5f} moles")
    #showing the user whether the inputted formula is known or unknown
    print(f"{known_formula}")
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    #HERE is my exceeding requirements checking if the user inputted formula is in the dictionary
...
def get_formula_name(formula, known_molecules_dict):
    ...
    if formula in known_molecules_dict:
        ...
        known_formula = "unknown compound"
    return known_formula
